@php
    $html_tag_data = [];
    $title = 'تفاصيل المسوقين';
    $description= 'تفاصيل المسوقين'
@endphp
    ...
    <div class="container">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        <a href="#" class="muted-link pb-1 d-inline-block breadcrumb-back">
                            ...
                            <span class="text-small align-middle">المسوقين</span>
                        </a>
                ...
                <div class="col-12 col-md-5 d-flex align-items-end justify-content-end">
                    ...
                    <div class="ms-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <button class="dropdown-item" type="button">عرض المشتريات</button>
                        </div>
                    </div>
                    <!-- Dropdown Button End -->
                </div>
        ...
        <div class="row gx-4 gy-5">
            ...
            <div class="col-12 col-xl-4 col-xxl-3">
                <h2 class="small-title">معلومات</h2>
                <div class="card">
                    <div class="card-body mb-n5">
                        <div class="d-flex align-items-center flex-column">
                            <div class="mb-5 d-flex align-items-center flex-column">
                                <div class="sw-6 sh-6 mb-3 d-inline-block bg-primary d-flex justify-content-center align-items-center rounded-xl">
                                    <div class="text-white">م ح</div>
                                </div>
                                <div class="h5 mb-1">مصطفي حموية</div>
                                <div class="text-muted">
                                    <i data-acorn-icon="pin" class="text-muted"></i>
                                    <span class="align-middle">الجزائر، بيلم</span>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            <div class="d-flex flex-row justify-content-between w-100 w-sm-50 w-xl-100 mb-5">
                                <button type="button" class="btn btn-primary w-100 me-2">تعديل</button>
                                <button type="button" class="btn btn-outline-primary w-100 me-2">حظر</button>
                        ...
                        <div class="mb-5">
                            <div class="row g-0 align-items-center mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">المبلغ الإجمالي </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="row g-0 align-items-center mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">متوسط الطلبات</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="row g-0 align-items-center mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">عدد الطلابات</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="mb-5">
                            <div>
                                <p class="text-small text-muted mb-2">معالومات العميل</p>
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col text-alternate align-middle">مصطفي حموية</div>
                                </div>
                                <div class="row g-0 mb-2">
                                    <div class="col-auto">
                                        <div class="sw-3 me-1">
                                    ...
                                    <div class="col text-alternate">الجزائر، بروبة بيلام</div>
                                </div>
                                <div class="row g-0 mb-2">
                                    <div class="col-auto">
                                        <div class="sw-3 me-1">
                                    ...
                                    <div class="col text-alternate">+23561022630</div>
                                </div>
                                <div class="row g-0 mb-2">
                                    <div class="col-auto">
                                        <div class="sw-3 me-1">
                                    ...
                                    <div class="col text-alternate">contact@kacioussama.com</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-xl-8 col-xxl-9">
                ...
                <div class="d-flex justify-content-between">
                    <h2 class="small-title">أخر الطلابات</h2>
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 h-md-100">
                                            <div class="text-muted text-small d-md-none">المعرف</div>
                                        ...
                                        <div class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                            <div class="text-muted text-small d-md-none">المبلغ</div>
                      ...
                      <span>
                        ...
                        321.75
                                        ...
                                        <div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                            <div class="text-muted text-small d-md-none">التاريخ</div>
                                        ...
                                        <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 align-items-md-end">
                                            <div class="text-muted text-small d-md-none">الحالة</div>
                                            <div class="text-alternate">
                                                <span class="badge rounded-pill bg-outline-secondary">قيد الانتظار</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                      ...
                      <span>
                        ...
                        59.00
                                        ...
                                        <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 align-items-md-end">
                                            <div class="text-muted text-small d-md-none">الحالة</div>
                                            <div class="text-alternate">
                                                <span class="badge rounded-pill bg-outline-primary">تم التوصيل</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            <a href="#" class="heading stretched-link">طلب جديد</a>
                                            <div class="text-alternate">21.02.2024</div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            <a href="#" class="heading stretched-link">تسجيل</a>
                                            <div class="text-alternate">12.02.2021</div>
