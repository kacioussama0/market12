              ...
              <input type="checkbox" class="form-check-input" id="checkAll" />
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="#">
                                <span class="align-middle d-inline-block">الحالة</span>
                            </a>
                            <a class="dropdown-item" href="#">
                                <span class="align-middle d-inline-block">تحريك</span>
                            </a>
                            <a class="dropdown-item" href="#">
                                <span class="align-middle d-inline-block">حذف</span>
                            </a>
                        </div>
                    </div>
                    <!-- Check Button End -->
          ...
          <i data-acorn-icon="close"></i>
            ...
            >
              10 Items
                        ...
                        <div class="dropdown-menu shadow dropdown-menu-end">
                            <a class="dropdown-item" href="#"> أغراض 5</a>
                            <a class="dropdown-item active" href="#">10 أغراض</a>
                            <a class="dropdown-item" href="#">20 أغراض</a>
                        </div>
                    </div>
                    <!-- Length End -->
                </div>
                        ...
                        <div class="col">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="col-lg-1 d-flex align-items-center mb-2 mb-lg-0 text-muted text-small">المعرف</div>
                                    <div class="col-lg-2 d-flex align-items-center text-muted text-small">الإسم</div>
                                    <div class="col-lg-2 d-flex align-items-center text-muted text-small">الموقع</div>
                                    <div class="col-lg-2 d-flex align-items-center text-muted text-small">إنفاق</div>
                                    <div class="col-lg-2 d-flex align-items-center text-muted text-small">أخر الطلبات</div>
                                    <div class="col-lg-2 d-flex align-items-center text-muted text-small">الحالة</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div class="col-11 col-lg-1 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-1 order-lg-1 h-lg-100 position-relative">
                                    <div class="text-muted text-small d-lg-none">المعرف</div>
                                ...
                                <div class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">الإسم</div>
                                ...
                                <div class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-5 order-lg-3">
                                    <div class="text-muted text-small d-lg-none">الموقع</div>
                                ...
                                <div class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-4 order-lg-4">
                                    <div class="text-muted text-small d-lg-none">إ</div>
                  ...
                  <span>
                    ...
                    321.75
                                ...
                                <div class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-5 order-lg-4">
                                    <div class="text-muted text-small d-lg-none">أخر الطلبات</div>
                                    <div class="text-alternate">
                                ...
                                <div class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
                                    <div class="text-muted text-small d-lg-none mb-1">الحالة</div>
                                    <div>
                                        <i
                    ...
                    <div class="card mb-2">
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                ...
                                <div class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-5 order-lg-4">
                                    <div class="text-muted text-small d-lg-none">أخر الطلابات</div>
                                    <div class="text-alternate">-</div>
                                </div>
                                <div class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
                                    <div class="text-muted text-small d-lg-none mb-1">الحالة</div>
