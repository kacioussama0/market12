        ...
        <div class="page-title-container">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        <a href="#" class="muted-link pb-1 d-inline-block breadcrumb-back">
                            ...
                            <span class="text-small align-middle">متجر الرئيسي</span>
                        </a>
                ...
                <div class="col-12 col-md-5 d-flex align-items-end justify-content-end">
                    ...
                    <div class="dropdown-as-select w-100 w-md-auto" data-childSelector="span">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item active" href="#">العادي</a>
                            <a class="dropdown-item" href="#">السعر تصاعدي</a>
                            <a class="dropdown-item" href="#">السعرتنازلي</a>
                            <a class="dropdown-item" href="#">تقييم</a>
            ...
            <span class="form-check float-end">
              <input type="checkbox" class="form-check-input" id="checkAll" />
                        ...
                        ></button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <button class="dropdown-item" type="button">نسخ</button>
                            <button class="dropdown-item" type="button">تحريك</button>
