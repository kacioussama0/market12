            ...
            <div class="card-body">
                ...
                <div>
                    <div class="row mb-4 d-none d-sm-flex">
                        <div class="col-6">
                            <p class="mb-0 text-small text-muted">إسم الغرض</p>
                        </div>
                        <div class="col-3">
                            <p class="mb-0 text-small text-muted">كمية</p>
                        </div>
                        <div class="col-3 text-end">
                            <p class="mb-0 text-small text-muted">المبلغ</p>
                        </div>
                    </div>
