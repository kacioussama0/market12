    ...
    <div class="container">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        <a href="#" class="muted-link pb-1 d-inline-block breadcrumb-back">
                            ...
                            <span class="text-small align-middle">المتجر الرئيسي</span>
                        </a>
        ...
        <div class="row">
            <div class="col-12 col-lg order-1 order-lg-0">
                <!-- Items Start -->
                <h2 class="small-title">أغراضي</h2>
                <div class="mb-5">
                    <div class="card mb-2">
            ...
            <div class="col-12 col-lg-auto order-0 order-lg-1">
                <!-- Summary Start -->
                <h2 class="small-title">المبلغ الإجمالي</h2>
                <div class="card mb-5 w-100 sw-lg-35">
                    <div class="card-body">
                        <div class="mb-4">
                            <div class="mb-2">
                                <p class="text-small text-muted mb-1">أغراض</p>
                                <p>
                ...
                <span class="text-alternate">
                  ...
                  285.25
                            ...
                            <div class="mb-2">
                                <p class="text-small text-muted mb-1">توصيل</p>
                                <p>
                <span class="text-alternate">
                  <span class="text-small text-muted">$</span>
                  12.50
                            ...
                            <div class="mb-2">
                                <p class="text-small text-muted mb-1">مباع</p>
                                <p>
                <span class="text-alternate">
                  <span class="text-small text-muted">$</span>
                  -24.50
                            ...
                            <div class="mb-2">
                                <p class="text-small text-muted mb-1">المبلغ الإجماليL</p>
                                <div class="cta-2">
                <span>
