@php
    $html_tag_data = [];
    $title = 'الرئيسية';
    $description= 'الصفحة الرئيسية للشراء ونجاح في مشروعك'
@endphp
    ...
    <div class="container">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <h1 class="mb-0 pb-0 display-4" id="title">أهلا مصطفي حموية </h1>
                </div>
                <!-- Title End -->
            </div>
        </div>
                    ...
                    <div class="dropdown-as-select me-3" data-setActive="false" data-childSelector="span">
                        ...
                        <div class="dropdown-menu font-standard">
                            <div class="nav flex-column" role="tablist">
                                <a class="active dropdown-item text-medium" href="#" aria-selected="true" role="tab">اليوم</a>
                                <a class="dropdown-item text-medium" href="#" aria-selected="false" role="tab">اسبوعي</a>
                                <a class="dropdown-item text-medium" href="#" aria-selected="false" role="tab">شهري</a>
                                <a class="dropdown-item text-medium" href="#" aria-selected="false" role="tab">عامي</a>
                            </div>
                        </div>
                    </div>
                    <h2 class="small-title">إحصائيات</h2>
                </div>
                <div class="mb-5">
                    <div class="row g-2">
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="card h-100 hover-scale-up cursor-pointer">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">محاصيل</div>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="card h-100 hover-scale-up cursor-pointer">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">طلبات</div>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="card h-100 hover-scale-up cursor-pointer">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">جلسات</div>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="card h-100 hover-scale-up cursor-pointer">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">المسوقين</div>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="card h-100 hover-scale-up cursor-pointer">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">الرجوع</div>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="card h-100 hover-scale-up cursor-pointer">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">تعليقات</div>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 mb-5">
                <h2 class="small-title">أخر الطلبات</h2>
                            ...
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    ...
                                    <div class="col-2 col-md-3 d-flex align-items-center text-muted mb-1 mb-md-0 justify-content-end justify-content-md-start">
                                        <span class="badge bg-outline-primary me-1">في إنتظار</span>
                                    </div>
                    ...
                    <div class="card-body h-100">
                        <div class="h-100">
                            ...
                            >
                                ...
                                <div>
                                    <span class="text d-flex align-middle text-alternate align-items-center text-small">T-shirt</span>
        ...
        <div class="row gx-4 gy-5">
            ...
            <div class="col-xl-6 mb-5">
                <h2 class="small-title">أفضل المبيعات </h2>
            ...
            <div class="col-xl-6 mb-5">
                <h2 class="small-title">الأكثر بحثا</h2>
        ...
        <div class="row">
            <div class="col-12 col-xxl">
                <div class="row">
                    ...
                    <div class="col-xxl-6 mb-5">
                        <h2 class="small-title">أخر تعليقات</h2>
                        <div class="card sh-35">
