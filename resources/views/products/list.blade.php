                ...
                <div class="col-12 col-sm-6 col-md-auto d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
                    ...
                    <div class="dropdown d-inline-block d-lg-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-end custom-sort">
                            <a class="dropdown-item sort" data-sort="name" href="#">العنوان</a>
                            <a class="dropdown-item sort" data-sort="email" href="#">المخزون</a>
                            <a class="dropdown-item sort" data-sort="phone" href="#">المبلغ</a>
                            <a class="dropdown-item sort" data-sort="group" href="#">الحالة</a>
                        </div>
                    </div>
            ...
            <span class="form-check float-end">
              <input type="checkbox" class="form-check-input" id="checkAll" />
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <button class="dropdown-item" id="deleteChecked" type="button">حذف</button>
                        </div>
                    </div>
                </div>
                <!-- Top Buttons End -->
                                ...
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-center custom-sort">
                                        <div class="col-lg-4 d-flex flex-column mb-lg-0 pe-3 d-flex">
                                            <div class="text-muted text-small cursor-pointer sort" data-sort="name">العنوان</div>
                                        </div>
                                        <div class="col-lg-2 d-flex flex-column pe-1 justify-content-center">
                                            <div class="text-muted text-small cursor-pointer sort" data-sort="email">المخزون</div>
                                        </div>
                                        <div class="col-lg-3 d-flex flex-column pe-1 justify-content-center">
                                            <div class="text-muted text-small cursor-pointer sort" data-sort="phone">المبلغ</div>
                                        </div>
                                        <div class="col-lg-2 d-flex flex-column pe-1 justify-content-center">
                                            <div class="text-muted text-small cursor-pointer sort" data-sort="group">الحالة</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
