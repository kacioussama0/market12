    ...
    <div class="container">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        <a href="#" class="muted-link pb-1 d-inline-block breadcrumb-back">
                            ...
                            <span class="text-small align-middle">المنتجات</span>
                        </a>
                ...
                <div class="col col-md-auto d-flex align-items-end justify-content-end">
                    <div class="btn-group ms-1 w-100 w-md-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <button class="dropdown-item" type="button">غير منشور</button>
        ...
        <div class="row">
            <div class="col-xl-8">
                <!-- Product Info Start -->
                <div class="mb-5">
                    <h2 class="small-title">تفاصيل المنتجات</h2>
                    <div class="card">
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 w-100">
                                    <label class="form-label">تصنيفات</label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">محتوي</label>
                ...
                <!-- Inventory Start -->
                <div class="mb-5">
                    <h2 class="small-title">المخزون</h2>
                    <div class="card">
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                ...
                <div class="mb-5">
                  ...
                  <span class="mb-1 lh-1-25">الشراء العادي</span>
            ...
            <div class="col-xl-4 mb-n5">
                <!-- Price Start -->
                <div class="mb-5">
                    <h2 class="small-title">المبلغ</h2>
                    <div class="card">
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
