    ...
    <div class="container">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        <a href="#" class="muted-link pb-1 d-inline-block breadcrumb-back">
                            ...
                            <span class="text-small align-middle">الطلبات</span>
                        </a>
                ...
                <div class="col-12 col-md-5 d-flex align-items-end justify-content-end">
                    ...
                    <div class="dropdown-as-select w-100 w-md-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="#">الحالة: في إنتظار</a>
                            <a class="dropdown-item" href="#">الحالة: تم الطلب</a>
                            <a class="dropdown-item active" href="#">الحالة: تم إستلام</a>
                        </div>
                    </div>
                    <!-- Status Button End -->
                    ...
                    <div class="ms-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <button class="dropdown-item" type="button">إظهار الفاتورة</button>
                            <button class="dropdown-item" type="button">تتبع الطرد</button>
                        </div>
                    </div>
                    <!-- Dropdown Button End -->
                </div>
        ...
        <div class="row gx-4 gy-5">
            <div class="col-12 col-xl-8 col-xxl-9 mb-n5">
                <!-- Status Start -->
                <h2 class="small-title">الحالة</h2>
                <div class="mb-5">
                    <div class="row g-2">
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center lh-1-25">تعريف الطلب</div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center lh-1-25">حالة الطلب</div>
                                        <div class="text-primary">تم الإستلام</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center lh-1-25">تاريخ الإستلام</div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center lh-1-25">رمز التتبع</div>
                ...
                <!-- Cart Start -->
                <h2 class="small-title">العربة</h2>
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                              ...
                              <span>
                                ...
                                <div>
                                    <div class="row g-0 mb-2">
                                        <div class="col-auto ms-auto ps-3 text-muted">المبلغ الإجمالي</div>
                    ...
                    <span>
                      ...
                      285.25
                                    ...
                                    <div class="row g-0 mb-2">
                                        <div class="col-auto ms-auto ps-3 text-muted">شحن</div>
                                        <div class="col-auto sw-13 text-end">
                    <span>
                      <span class="text-small text-muted">$</span>
                      12.50
                                    ...
                                    <div class="row g-0 mb-2">
                                        <div class="col-auto ms-auto ps-3 text-muted">البيع</div>
                                        <div class="col-auto sw-13 text-end">
                    <span>
                      <span class="text-small text-muted">$</span>
                      -24.50
                ...
                <!-- Activity Start -->
                <h2 class="small-title">الفعالية</h2>
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row g-0">
                                ...
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            <a href="#" class="heading stretched-link">إستلام الطلب</a>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col mb-4">
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            <a href="#" class="heading stretched-link">تم الطلب</a>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            <a href="#" class="heading stretched-link pt-0">تم إستلام</a>
