        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                    <input class="form-control" placeholder="البحث" />
          ...
          <i data-acorn-icon="close"></i>
            ...
            >
              10 Items
                        ...
                        <div class="dropdown-menu shadow dropdown-menu-end">
                            <a class="dropdown-item" href="#">5 أغراض</a>
                ...
                <div class="card mb-2 bg-transparent no-shadow d-none d-md-block">
                    <div class="card-body pt-0 pb-0 sh-3">
                        <div class="row g-0 h-100 align-content-center">
                            <div class="col-md-2 d-flex align-items-center mb-2 mb-md-0 text-muted text-small">تعريف</div>
                            <div class="col-md-3 d-flex align-items-center text-muted text-small">الإسم</div>
                            <div class="col-md-2 d-flex align-items-center text-muted text-small">المبلغ</div>
                            <div class="col-md-2 d-flex align-items-center text-muted text-small">التاريخ</div>
                            <div class="col-md-2 d-flex align-items-center text-muted text-small">الحالة</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body pt-0 pb-0 sh-21 sh-md-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div class="col-11 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                                    <div class="text-muted text-small d-md-none">تعريف</div>
                                ...
                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                    <div class="text-muted text-small d-md-none">الإسم</div>
                  ...
                  <span>
                    ...
                    321.75
                                ...
                                <div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                                    ...
                                    <div class="text-alternate">
                                        <span class="badge rounded-pill bg-outline-primary">قبول الطلب</span>
                                    </div>
                                </div>
                  ...
                  <span>
                    ...
                    63.10
                                ...
                                <div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                                    <div class="text-muted text-small d-md-none">Status</div>
                                    <div class="text-alternate">
                                        <span class="badge rounded-pill bg-outline-secondary">تم الإستلام</span>
                                    </div>
                                </div>
                                <div class="col-1 col-md-1 d-flex flex-column justify-content-center align-items-md-end mb-2 mb-md-0 order-2 text-end order-md-last">
                                    <label class="form-check float-end pe-none mt-1">
                  ...
                  <span>
                    ...
                    79.75
                                ...
                                <div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                                    ...
                                    <div class="text-alternate">
                                        <span class="badge rounded-pill bg-outline-tertiary">تم الشراء</span>
                                    </div>
                                </div>
                                <div class="col-1 col-md-1 d-flex flex-column justify-content-center align-items-md-end mb-2 mb-md-0 order-2 text-end order-md-last">
                                    <label class="form-check float-end pe-none mt-1">
